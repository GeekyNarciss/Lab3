package bsu.rfe.java.group7.lab3.Nastachenko.varA;
...
public class MainLab3 extends JFrame {
    ...
    public MainLab3(Double[] coefficients) {
        ...
        Action saveToTextAction = new AbstractAction("Сохранить в текстовый файл") {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (fileChooser.showSaveDialog(MainLab3.this) == JFileChooser.APPROVE_OPTION)
        ...
        Action searchValueAction = new AbstractAction("Найти значение многочлена") {
            ...
            public void actionPerformed(ActionEvent event) {
                String value = JOptionPane.showInputDialog(MainLab3.this, "Введите значение для поиска",
        ...
        Action aboutProgramAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                JLabel author = new JLabel("Автор: Тёма");
                JLabel group = new JLabel("студент 7 группы");
                JLabel image=new JLabel(new ImageIcon(MainLab3.class.getResource("ezhik.jpg")));
                ...
                JOptionPane.showMessageDialog(MainLab3.this,
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    data = new GornerTable(from, to, step, MainLab3.this.coefficients);
    ...
    public static void main(String[] args) {
        ...
        MainLab3 frame = new MainLab3(coefficients);
